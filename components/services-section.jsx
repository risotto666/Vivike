  ...
  const services = [
    {
      ...
      title: "CRM Analytics",
      description:
        "Custom analytics dashboards to track customer interactions and business performance.",
    },
    {
      icon: <Users className="h-12 w-12 text-[#8c7851]" />,
      title: "Lead Management",
      description:
        "Streamlined lead capture, tracking, and conversion processes tailored to your business.",
    },
    {
      icon: <MessageSquare className="h-12 w-12 text-[#8c7851]" />,
      title: "Communication Tools",
      description:
        "Integrated communication solutions to engage with your customers effectively.",
    },
    {
      icon: <Settings className="h-12 w-12 text-[#8c7851]" />,
      title: "CRM Customization",
      description:
        "Personalized CRM setup to match your specific business workflows and requirements.",
    },
  ];
            ...
            <motion.div key={index} variants={item}>
              <Card className="bg-white border-[#e6dcc6] h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                <CardHeader className="pb-2">
                  {service.icon}
                  <CardTitle className="text-xl text-[#8c7851] mt-4">
                    {service.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
